...
# KOS main base path
export KOS_BASE="${HOME}/dreamcast/KallistiOS"
...
# Compiler prefixes
export KOS_CC_BASE="${HOME}/dreamcast/netbsd/usr/src/obj/tooldir.Linux-5.0.0-23-generic-x86_64"
export KOS_CC_PREFIX="shle--netbsdelf"
...
# multiple sourcing of this file.
export KOS_CFLAGS=""
export KOS_CPPFLAGS=""
export KOS_LDFLAGS=""
export KOS_AFLAGS=""

# Setup some default CFLAGS for compilation. The things that will go here are
# user specifyable, like optimization level and whether you want stack traces
# enabled. Some platforms may have optimization restrictions, please check
# README.
#
# GCC seems to have made -fomit-frame-pointer the default on many targets, so
# hence you may need -fno-omit-frame-pointer to actually have GCC spit out
# frame pointers. It won't hurt to have it in there either way.
